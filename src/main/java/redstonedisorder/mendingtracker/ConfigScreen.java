...
public class ConfigScreen extends Screen {
    ...
    @Override
    protected void init() {
        // TODO: Use actual values from the config (after it's implemented)
        ...
        Button logButton = Button.builder(Component.literal("Log button"), button -> {
            MendingTracker.LOGGER.info("Alignment: {}", effectiveAlignment);
            MendingTracker.LOGGER.info(configOptions.toString());
        }).bounds(100, 200, 200, 20).build();
